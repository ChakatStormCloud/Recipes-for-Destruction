...
public class Vanilla {
	...
	public static void addRecipes(){
		ExplosionDebris stick = new ExplosionDebris(Item.getByNameOrId("minecraft:stick"), 1, 1,false);
		ExplosionDebris plank = new ExplosionDebris(Item.getByNameOrId("minecraft:plank"),1,2,false);
